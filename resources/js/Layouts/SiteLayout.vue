        ...
        <header class="sticky top-0 z-40 border-b bg-white/80 backdrop-blur">
            <nav class="mx-auto flex h-14 max-w-7xl items-center justify-between px-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    title="Search"
                    >
                    <img src="/theme/icons/search.svg" alt="Search" class="h-5 w-5" />
                    </button>
                    ...
                    >
                    <img src="/theme/icons/cart.svg" alt="Cart" class="h-5 w-5" />
                    </Link>
                    ...
                    <transition name="fade">
                        ...
                        v-if="showAccount"
                        @click.stop  
                        class="absolute right-0 mt-2 w-48 overflow-hidden rounded-lg border bg-white shadow-lg z-50"
                        role="menu"
                        >
                        <template v-if="user">
                            <Link
                            ...
                            @click="showAccount = false"
                            >
                            <img src="/theme/icons/user-logout.svg" class="h-4 w-4" alt="" />
                            Logout
                            </Link>
                        </template>
                        <template v-else>
